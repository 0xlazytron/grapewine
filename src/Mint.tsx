                                                    ...
                                                    <section className="av_textblock_section">
                                                        ...
                                                        <div className="avia_textblock  " >
                                                            ...
                                                            <p style={{ textAlign: "center", color: "#000" }}>
                                                                ...
                                                                you have{" "} {whitelistTokenBalance} {" "}DBC's and You own {" "} {(balance || 0).toLocaleString()} SOL In Your Wallet</p>
                                                        </div>
                                                    </section>
                                                </div>
                                                <div className="flex_column av_three_fifth  no_margin flex_column_table_cell av-equal-height-column av-align-middle   avia-builder-el-4  el_after_av_two_fifth  avia-builder-el-last  newslatter-frm "
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            {/* <span className="avia_button_icon avia_button_icon_left" */}
                                                            {/* aria-hidden="true" data-av_icon="&#59410;" */}
                                                            {/* data-av_iconfont=""></span> */}
                                                        ...
                                                        <span
                                                            ...
                                                            <>
                                                                <SolExplorerLink href={solanaExplorerLink} target="_blank">View on
                                                                    ...
                                                                    <a href="mint-2.html"
                                                                        className="avia-button  avia-color-theme-color   avia-icon_select-no avia-size-small avia-position-center ">
                                                                            <span className="avia_iconbox_title">Mint with solana
                                                                            </span>
                                                                            </a>
                                                                            </div>
                                                                    ...
                                                                    {/* <Link to="/mint" className="avia-button  avia-color-theme-color avia-icon_select-yes-left-icon avia-size-large avia-position-center"
                                                                    
                                                                    style={{marginTop: "20px"}}>
                                                                        <span className="avia_iconbox_title">MINT GRAPHVINE NOW!</span> */}
                                                        </div>
                                                    </div>
                                                    <section className="av_textblock_section">
                                                        <div className="avia_textblock  av_inherit_color " style={{ color: "#999999" }}>
